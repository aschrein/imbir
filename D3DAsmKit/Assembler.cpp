...
"ld_aoffimmi",
"ld_indexable",
"ld_aoffimmi_indexable",
"ldms_aoffimmi",
"ldms_indexable",
"ldms_aoffimmi_indexable",
"resinfo_indexable",
"sample_aoffimmi",
"sample_indexable",
"sample_aoffimmi_indexable",
"sample_c_aoffimmi",
"sample_c_indexable",
"sample_c_aoffimmi_indexable",
"sample_c_lz_aoffimmi",
"sample_c_lz_indexable",
"sample_c_lz_aoffimmi_indexable",
"sample_l_aoffimmi",
"sample_l_indexable",
"sample_l_aoffimmi_indexable",
"sample_d_aoffimmi",
"sample_d_indexable",
"sample_d_aoffimmi_indexable",
"sample_b_aoffimmi",
"sample_b_indexable",
"sample_b_aoffimmi_indexable",
"gather4_aoffimmi",
"gather4_indexable",
...
HRESULT disassembler(vector<byte> const &buffer, std::string &outText, const char *comment) {
  byte fourcc[4];
  DWORD fHash[4];
  DWORD one;
  DWORD fSize;
  ...
  byte const *pPosition = buffer.data();
